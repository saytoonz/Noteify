...
public class Shared extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_main:
                    Intent i = new Intent(Shared.this, Collections.class);
                    startActivity(i);
                    return true;
                case R.id.navigation_add:
                    Intent j = new Intent(Shared.this, NewNotebookNote.class);
                    startActivity(j);
                    Bungee.zoom(mContext);
                    return true;
                case R.id.navigation_account:
                    Intent k = new Intent(Shared.this, Account.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Shared (Sort: Newest to Oldest)");
