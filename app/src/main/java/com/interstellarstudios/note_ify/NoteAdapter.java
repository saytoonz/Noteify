...
public class NoteAdapter extends FirestoreRecyclerAdapter<Note, NoteAdapter.NoteHolder> {
    ...
    public NoteAdapter(@NonNull FirestoreRecyclerOptions<Note> options, SharedPreferences sharedPreferences) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull NoteHolder holder, int position, @NonNull Note model) {
        ...
        //String htmlDescription = model.getDescription();

        //if (htmlDescription == null){
            //holder.mEditor.setHtml("");
        //} else {

            holder.mEditor.setHtml(model.getDescription());
            //holder.textViewDescription.setText(Html.fromHtml(htmlDescription));

            //if (isOnline() == true) {
                //holder.textViewDescription.setText(Html.fromHtml(htmlDescription, new URLImageParser(holder.textViewDescription), null));
            //} else {
                //holder.textViewDescription.setText(Html.fromHtml(htmlDescription));
            //}
        //}

        if (switchOnOff2 == true) {
    ...
    public void moveItem2(int position) {
        ...
        DocumentReference NotebookDocumentPath = db.collection("Users").document(current_user_id).collection("Main").document("Notebook");
        ...
        DocumentReference to = db.collection("Users").document(current_user_id).collection("Main").document("Notebook").collection("Notebook").document(id);
        moveFirestoreDocument(from, to);
    }
    ...
    class NoteHolder extends RecyclerView.ViewHolder {
        ...
        public NoteHolder(View itemView) {
            ...
            mEditor.setBackgroundColor(Color.parseColor("#1f1f1f"));
