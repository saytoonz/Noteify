...
public class NotesSortPriority extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color=\"" + colorLightThemeTextString + "\">" + (folderId + " (Sort: Priority)") + "</font>"));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(NotesSortPriority.this, NewNote.class);
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    switch (keyCode) {
                        ...
                        case KeyEvent.KEYCODE_ENTER:
                            ...
                            Intent i = new Intent(NotesSortPriority.this, NotesSearchResults.class);
        ...
        if(switchThemesOnOff) {
            ...
            layout.setBackgroundColor(ContextCompat.getColor(NotesSortPriority.this, R.color.colorPrimaryDarkTheme));
            String colorDarkThemeTextString = "#" + Integer.toHexString(ContextCompat.getColor(this, R.color.colorDarkThemeText));
            getSupportActionBar().setTitle(Html.fromHtml("<font color=\"" + colorDarkThemeTextString + "\">" + (folderId + " (Sort: Priority)") + "</font>"));
            ...
            searchField.setTextColor(ContextCompat.getColor(NotesSortPriority.this, R.color.colorDarkThemeText));
            searchField.setHintTextColor(ContextCompat.getColor(NotesSortPriority.this, R.color.colorDarkThemeText));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.sort_date) {
            ...
            String folderId = bundle.getString("folderId");
            Intent i = new Intent(NotesSortPriority.this, Notes.class);
            i.putExtra("folderId", folderId);
            startActivity(i);
            return true;
        }
        if (id == R.id.sort_alphabetically) {
            Bundle bundle = getIntent().getExtras();
            String folderId = bundle.getString("folderId");
            Intent i = new Intent(NotesSortPriority.this, NotesSortAlphabetical.class);
            i.putExtra("folderId", folderId);
            startActivity(i);
            return true;
        }
    ...
    private void setUpRecyclerView() {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                adapter.moveItem3(viewHolder.getAdapterPosition(), NotesSortPriority.this, folderId, directory);
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_new_note) {
            ...
            Intent j = new Intent(NotesSortPriority.this, Home.class);
            startActivity(j);
        }else if (id == R.id.nav_share) {
            Intent j = new Intent(NotesSortPriority.this, Shared.class);
            startActivity(j);
            ...
            Intent m = new Intent(NotesSortPriority.this, Settings.class);
            startActivity(m);
        } else if (id == R.id.nav_account) {
            Intent n = new Intent(NotesSortPriority.this, Account.class);
            startActivity(n);
        } else if (id == R.id.nav_information) {
            Intent o = new Intent(NotesSortPriority.this, Information.class);
            startActivity(o);
        }
        DrawerLayout drawer = findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
