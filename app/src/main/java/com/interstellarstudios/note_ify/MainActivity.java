...
public class MainActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_main:
                    Intent i = new Intent(MainActivity.this, Collections.class);
                    startActivity(i);
                    return true;
                case R.id.navigation_share:
                    Intent j = new Intent(MainActivity.this, Shared.class);
                    startActivity(j);
                    return true;
                case R.id.navigation_add:
                    Bundle bundle = getIntent().getExtras();
                    String folderId = bundle.getString("folderId");
                    Intent k = new Intent(MainActivity.this, NewNote.class);
                    k.putExtra("folderId", folderId);
                    startActivity(k);
                    Bungee.zoom(context);
                    return true;
                case R.id.navigation_account:
                    Intent l = new Intent(MainActivity.this, Account.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle(folderId + " (Sort: Newest to Oldest)");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.sort_alphabetically) {
            Bundle bundle = getIntent().getExtras();
            String folderId = bundle.getString("folderId");
            Intent i = new Intent(MainActivity.this, SortAlphabetical.class);
            i.putExtra("folderId", folderId);
            startActivity(i);
            return true;
        }
        if (id == R.id.sort_priority) {
            Bundle bundle = getIntent().getExtras();
            String folderId = bundle.getString("folderId");
            Intent i = new Intent(MainActivity.this, SortPriority.class);
            i.putExtra("folderId", folderId);
            startActivity(i);
            return true;
        }
    ...
    private void setUpRecyclerView() {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                adapter.moveItem3(viewHolder.getAdapterPosition(), MainActivity.this, folderId, directory);
            }
