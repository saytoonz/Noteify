...
public class SortAlphabetical extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_main:
                    Intent i = new Intent(SortAlphabetical.this, Collections.class);
                    startActivity(i);
                    return true;
                case R.id.navigation_share:
                    Intent j = new Intent(SortAlphabetical.this, Shared.class);
                    startActivity(j);
                    return true;
                case R.id.navigation_add:
                    Intent k = new Intent(SortAlphabetical.this, NewNote.class);
                    startActivity(k);
                    Bungee.zoom(context);
                    return true;
                case R.id.navigation_account:
                    Intent l = new Intent(SortAlphabetical.this, Account.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle(folderId + " (Sort: Alphabetical)");
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    switch (keyCode) {
                        ...
                        case KeyEvent.KEYCODE_ENTER:
                            ...
                            Intent i = new Intent(SortAlphabetical.this, SearchResults.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.sort_date) {
            ...
            Intent i = new Intent(SortAlphabetical.this, MainActivity.class);
            i.putExtra("folderId", folderId);
            startActivity(i);
            return true;
        }
        if (id == R.id.sort_priority) {
            Bundle bundle = getIntent().getExtras();
            String folderId = bundle.getString("folderId");
            Intent i = new Intent(SortAlphabetical.this, SortPriority.class);
            i.putExtra("folderId", folderId);
            startActivity(i);
            return true;
        }
    ...
    private void setUpRecyclerView() {
        ...
        CollectionReference notebookRef = db.collection("Users").document(current_user_id).collection("Main").document(folderId).collection(folderId);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                adapter.moveItem3(viewHolder.getAdapterPosition(), SortAlphabetical.this, folderId, directory);
            }
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(SortAlphabetical.this, EditNote.class);
                i.putExtra("folderId", folderId);
