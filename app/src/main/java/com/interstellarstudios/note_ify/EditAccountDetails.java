    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mFirebaseAnalytics.logEvent("profile_updated", analyticsBundle);
                saveDetails();
                finish();
        ...
        buttonDelete = findViewById(R.id.confirm_delete);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Users/" + current_user_id + "/Profile_Pic");

        editFirstName = findViewById(R.id.editFirstName);
        editLastName = findViewById(R.id.editLastName);

        DocumentReference detailsRef = FirebaseFirestore.getInstance()
                .collection("Users").document(current_user_id).collection("User_Details").document("This User");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        detailsRef.set(new Details(firstName, lastName, profilePicURL));

                    } else {
                        detailsRef.set(new Details(firstName, lastName, "Profile Pic Not Uploaded"));
                    }
                }
            }
        });
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                detailsRef.set(new Details(firstName, lastName, downloadURL));
                            }
                        }
                    });
        }
