        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_main:
                    Intent i = new Intent(SearchResults.this, Collections.class);
                    startActivity(i);
                    return true;
                case R.id.navigation_share:
                    Intent j = new Intent(SearchResults.this, Shared.class);
                    startActivity(j);
                    return true;
                case R.id.navigation_add:
                    Bundle bundle = getIntent().getExtras();
                    String folderId = bundle.getString("folderId");
                    Intent k = new Intent(SearchResults.this, NewNote.class);
                    k.putExtra("folderId", folderId);
                    startActivity(k);
                    Bungee.zoom(context);
                    return true;
                case R.id.navigation_account:
                    Intent l = new Intent(SearchResults.this, Account.class);
    ...
    private void setUpRecyclerView() {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                adapter.moveItem3(viewHolder.getAdapterPosition(), SearchResults.this, folderId, directory);
            }
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(SearchResults.this, EditNote.class);
