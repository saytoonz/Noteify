...
public class SharedSearchResults extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(switchThemesOnOff) {
            ...
            layout.setBackgroundColor(ContextCompat.getColor(SharedSearchResults.this, R.color.colorPrimaryDarkTheme));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.sort_date) {
            Intent i = new Intent(SharedSearchResults.this, Shared.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.sort_alphabetically) {
            Intent i = new Intent(SharedSearchResults.this, SharedSortAlphabetical.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.sort_priority) {
            Intent i = new Intent(SharedSearchResults.this, SharedSortPriority.class);
            startActivity(i);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_new_note) {
            ...
            Intent j = new Intent(SharedSearchResults.this, Shared.class);
            startActivity(j);
        } else if (id == R.id.nav_grocery_list) {
            Intent k = new Intent(SharedSearchResults.this, GroceryList.class);
            startActivity(k);
        } else if (id == R.id.nav_shared_grocery_list) {
            Intent k = new Intent(SharedSearchResults.this, SharedGroceryList.class);
            startActivity(k);
        } else if (id == R.id.nav_bin) {
            Intent l = new Intent(SharedSearchResults.this, Bin.class);
            startActivity(l);
        } else if (id == R.id.nav_dark) {

        } else if (id == R.id.nav_settings) {
            Intent m = new Intent(SharedSearchResults.this, Settings.class);
            startActivity(m);
        } else if (id == R.id.nav_account) {
            Intent n = new Intent(SharedSearchResults.this, Account.class);
            startActivity(n);
        } else if (id == R.id.nav_information) {
            Intent o = new Intent(SharedSearchResults.this, Information.class);
            startActivity(o);
        } else if (id == R.id.nav_faq) {
            Intent p = new Intent(SharedSearchResults.this, FAQ.class);
            startActivity(p);
        }
        DrawerLayout drawer = findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
