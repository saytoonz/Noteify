...
public class GroceryAdapter extends RecyclerView.Adapter<GroceryAdapter.GroceryViewHolder> {
    ...
    public GroceryAdapter(Context context, Cursor cursor, SharedPreferences sharedPreferences) {
    ...
    public class GroceryViewHolder extends RecyclerView.ViewHolder {
        ...
        public LinearLayout groceryItem;
    ...
    public void onBindViewHolder(GroceryViewHolder holder, int position) {
        ...
        if (switchThemesOnOff){
            ...
            holder.nameText.setTextColor(Color.parseColor(colorDarkThemeTextString));
            holder.countText.setTextColor(Color.parseColor(colorDarkThemeTextString));
            holder.groceryItem.setBackgroundColor(ContextCompat.getColor(mContext, R.color.colorPrimaryDarkTheme));
        }
