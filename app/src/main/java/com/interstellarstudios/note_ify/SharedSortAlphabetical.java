...
public class SharedSortAlphabetical extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color=\"" + "#000000" + "\">" + "Shared (Sort: Alphabetical)" + "</font>"));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SharedSortAlphabetical.this, NewNote.class);
    ...
    private void setUpRecyclerView() {
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(SharedSortAlphabetical.this, EditNote.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_new_note) {
            ...
            Intent p = new Intent(SharedSortAlphabetical.this, FAQ.class);
            startActivity(p);
        }
        DrawerLayout drawer = findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
