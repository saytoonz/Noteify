...
public class SharedSortAlphabetical extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_main:
                    Intent i = new Intent(SharedSortAlphabetical.this, Collections.class);
                    startActivity(i);
                    return true;
                case R.id.navigation_add:
                    Intent j = new Intent(SharedSortAlphabetical.this, NewNotebookNote.class);
                    startActivity(j);
                    Bungee.zoom(context);
                    return true;
                case R.id.navigation_account:
                    Intent k = new Intent(SharedSortAlphabetical.this, Account.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Shared (Sort: Alphabetical)");
